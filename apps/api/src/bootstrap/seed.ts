import { db } from '../db'
import { hashPassword, makeId } from '../utils'
import { upsertRegion } from '../repositories/region-repo'
...
export async function ensureBootstrapData() {
  ...
  const organizationCount = await db.query<{ count: string }>('SELECT COUNT(*)::text AS count FROM organizations')
